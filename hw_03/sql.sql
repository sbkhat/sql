...
ALTER TABLE vk.groups ADD CONSTRAINT fk_groups_user_id FOREIGN KEY (user_id) REFERENCES vk.users (id);
CREATE INDEX groups_user_id ON vk.groups (user_id);
...
ALTER TABLE vk.user_groups ADD CONSTRAINT fk_user_groups_user_id FOREIGN KEY (user_id) REFERENCES vk.users (id);
ALTER TABLE vk.user_groups ADD CONSTRAINT fk_user_groups_group_id FOREIGN KEY (group_id) REFERENCES vk.groups (id);
...
ALTER TABLE vk.message_groups ADD CONSTRAINT fk_message_groups_user_id FOREIGN KEY (user_id) REFERENCES vk.users(id);
ALTER TABLE vk.message_groups ADD CONSTRAINT fk_message_groups_group_id FOREIGN KEY (group_id) REFERENCES vk.groups (id);
