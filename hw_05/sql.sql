...
CREATE TABLE users (
  ...
  created_at DATETIME DEFAULT null COMMENT "Время создания строки",
  updated_at DATETIME DEFAULT null COMMENT "Время обновления строки"
) COMMENT "Пользователи";

INSERT INTO users (`name`) VALUES ('123');
INSERT INTO users (`name`) VALUES ('323232');
INSERT INTO users (`name`) VALUES ('43434');

--ставим null в датах
UPDATE users SET updated_at = null WHERE (id = 1);
UPDATE users SET created_at = null, updated_at = null WHERE (id = 2);
UPDATE users SET created_at = null WHERE (id = 3);
